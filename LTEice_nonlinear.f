C******************************
C Laplace Tidal Equations, with bottom drag (nonlinear), with ice cap
C
...
C    modify it to solve many other tidal dissipation problems (with 
C    ice cap).  Parameters most likely to be modified by users are 
C    preceded by C???????????
C
...
C
C To get MATLAB plots, remove all "C!" from LTEice_nonlinear.f and pde2d.m  
C and pde2d.rdm will be produced when you run runpde2d.  If you run MATLAB
